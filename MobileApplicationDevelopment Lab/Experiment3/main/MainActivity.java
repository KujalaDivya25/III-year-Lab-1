...
public class MainActivity extends AppCompatActivity implements FragmentActionListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(findViewById(R.id.activity_main_portrait)!= null){
            ...
            addCandidatesFragment();
            if(savedInstanceState==null){
                addCandidateDescriptionFragment(R.id.fragmentContainer2,"Mamatha");
            }else{
    ...
    protected void onRestoreInstanceState(Bundle savedInstanceState) {
        ...
        Log.i("OrintationChange","MainActivity onSaveInstanceState");
        selectedCandidate = savedInstanceState.getString("selectedCandidate","Mamatha");
    }

    private void addCandidatesFragment(){
        fragmentTransaction=fragmentManager.beginTransaction();

        CandidatesFragment candidateListFragment=new CandidatesFragment();
    ...
    private void addCandidateDescriptionFragment(String candidateName){
        ...
        bundle.putString(FragmentActionListener.KEY_SELECTED_CANDIDATE,candidateName);
